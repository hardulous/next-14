...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      {/* Here even if we are wrapping the entire application (children) inside a client component (ThemeProvider), Still server component down the tree remains server component. */}
      <ThemeProvider>
        <body>
          <header
            style={{
...
// Here in this server component we will render the context <Provider/> component
